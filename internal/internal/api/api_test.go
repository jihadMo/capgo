...
type stubStore struct {
	...
	contractStatsResult  *store.ContractStats
	contractStatsErr     error
...
func (s *stubStore) ContractStats(ctx context.Context, contractID string, sc store.Scope) (store.ContractStats, error) {
	if s.contractStatsErr != nil {
		return store.ContractStats{}, s.contractStatsErr
	}
	if s.contractStatsResult != nil {
		return *s.contractStatsResult, nil
	}
	return store.ContractStats{}, store.ErrNotFound
}

func (s *stubStore) GetContractSummary(ctx context.Context, contractID string, sc store.Scope) (store.ContractSummary, error) {
	if s.getContractSummaryErr != nil {
		return store.ContractSummary{}, s.getContractSummaryErr
	}
	if s.getContractSummaryResult != nil {
		return *s.getContractSummaryResult, nil
	}
