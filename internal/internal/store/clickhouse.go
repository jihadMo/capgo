...
func (c *ClickHouse) ContractStats(context.Context, string, Scope) (ContractStats, error) {
	return ContractStats{}, fmt.Errorf("ContractStats: not supported by clickhouse backend")
}

func (c *ClickHouse) GetContractSummary(context.Context, string, Scope) (ContractSummary, error) {
	return ContractSummary{}, fmt.Errorf("GetContractSummary: not supported by clickhouse backend")
}
